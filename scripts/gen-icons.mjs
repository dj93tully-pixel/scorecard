...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
  ...
  <path d="M34 49 L40 75 Q50 81 60 75 L66 49" fill="none" stroke="#6E80E8" stroke-width="3.4" stroke-linecap="round" stroke-linejoin="round"/>
  <ellipse cx="50" cy="49" rx="16" ry="4" fill="none" stroke="#6E80E8" stroke-width="3.4"/>
  <path d="M66 54 Q77 54 75 64 Q73 70 65 68" fill="none" stroke="#6E80E8" stroke-width="3.4" stroke-linecap="round"/>
