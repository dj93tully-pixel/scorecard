...
export function HackerTrackerMark({
  ...
  return (
    ...
    >
      <path d="M50 50 L50 22 A28 28 0 0 1 70 30 Z" fill="var(--logo-color)" opacity="0.30" />
      <circle cx="50" cy="50" r="27" fill="none" stroke="var(--logo-color)" strokeWidth="2.8" />
      <circle cx="50" cy="50" r="20" fill="none" stroke="var(--logo-color)" strokeWidth="2.8" />
      <circle cx="50" cy="50" r="14" fill="none" stroke="var(--logo-color)" strokeWidth="2.8" />
      <line x1="50" y1="50" x2="70" y2="30" stroke="var(--logo-color)" strokeWidth="3.2" strokeLinecap="round" />
      <circle cx="70" cy="30" r="3.8" fill="var(--logo-color)" />
